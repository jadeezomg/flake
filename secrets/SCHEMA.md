...
| `mini/media/qbittorrent/search-plugins` | JSON string: `{"official":["piratebay",...],"custom":["sukebeisi"]}` — plugin enable-list for qBittorrent search | nixflix `qbittorrent-pre-start` plugin sync | mini |
