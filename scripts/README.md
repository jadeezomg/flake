...
| Package root | `symlinks.py`, `update_packages.py`, `media_quality.py` (other entry points). |
...
Root `Justfile` sets `script-interpreter` for uv-backed recipes; see recipe docs there for `zen-sync`, `zen-check`, `symlink-check`, etc.
