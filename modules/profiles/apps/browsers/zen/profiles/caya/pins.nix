...
in
{
  ...
  pins = {
    ...
    "Caya GmbH - Calendar - Week of August 10, 2026" = {
    ...
    "Solutions › Overview" = {
      id = "4be84089-5a1c-4de2-8502-5aad2e06071d";
  ...
  spaces = baseSpaces // {
    "Solutions" = baseSpaces."Solutions" // {
      pins = {
        "Automat" = {
          id = "{1772811910849-71}";
          isGroup = true;
        ...
        "Mailroom" = {
          id = "1124f369-7342-4765-adb5-27bb48956ee3";
