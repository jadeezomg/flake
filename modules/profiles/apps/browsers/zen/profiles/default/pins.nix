# Pins and folders (space-scoped form). Generated by zen-sync.
# Close Zen before `just switch`: the activation script needs exclusive
# access to zen-sessions.jsonlz4, and silently skips the update otherwise.
_:
let
...
in
{
  ...
  spaces = baseSpaces // {
    ...
    "Development" = baseSpaces."Development" // {
      pins = {
        "Hosting" = {
          id = "{1781804380368-15}";
          isGroup = true;
    ...
    "Downloads" = baseSpaces."Downloads" // {
      pins = {
        "Download Clients" = {
