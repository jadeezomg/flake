{lib, ...}: {
  ...
  in {
    ...
    essentials.enable = enableOn "the essentials profile (shell theme, HM widgets, system env, Nix workstation tooling)";
    ...
    devenv = {
      ...
      llm = {
        agents.enable = mkEnableOption "devenv.llm.agents (opencode, claude-code, context7, kagi-ken, ...)";
