{
  ...
  tech = {
    ...
    npm = {
      char = "";
      hexCode = "nf-dev-E71E";
    }; # nf-dev-npm (also for yarn)
    yarn = {
      char = "";
      hexCode = "nf-dev-E71E";
    }; # nf-dev-npm (duplicate, same character as npm)
    platformio = {
      char = "";
      hexCode = "nf-seti-E682";
    }; # nf-seti-platformio
    vagrant = {
      char = "";
      hexCode = "nf-fa-F0218";
  ...
  typography = {
    languageGlobe = {
      char = "";
      hexCode = "nf-fa-F01AB";
    }; # nf-fa-language (for general language/locale)
    translate = {
      char = "󰗊";
      hexCode = "nf-md-F05CA";
    }; # nf-md-translate
    ...
    hashFingerprint = {
      char = "󰕥";
      hexCode = "nf-md-F0565";
    }; # nf-md-fingerprint (for checksums like SHA)
  };
  ...
  brackets = {
    separatorOpen = {
      char = "";
      hexCode = "U+E0B6";
    }; # nf-pl-right_half_circle_thick (from powerline)
    separatorClose = {
      char = "";
      hexCode = "U+E0B4";
    }; # nf-pl-left_half_circle_thick (from powerline)
    whichSeparator = {
      char = "";
      hexCode = "U+EA9C";
  ...
  programming = {
    ...
    rust = {
      char = "";
      hexCode = "nf-seti-E68B";
    }; # nf-seti-rust
    rustLib = {
      char = "";
      hexCode = "nf-dev-E7A8";
    }; # nf-dev-rust (specific for .rlib files)
    elixir = {
      char = "";
      hexCode = "nf-dev-E62D";
    }; # nf-dev-elixir
    ...
    vala = {
      char = "";
      hexCode = "nf-seti-E69E";
    }; # nf-seti-vala
    solidity = {
      char = "";
      hexCode = "nf-seti-E656";
    }; # nf-seti-solidity
    huff = {
      char = "󰡘";
      hexCode = "nf-md-F0858";
    ...
    haxe = {
      char = "";
      hexCode = "nf-seti-E666";
    }; # nf-seti-haxe
    mojo = {
      char = "";
      hexCode = "nf-md-F040C";
    }; # nf-md-fire (also used for general fire icon)
    verilog = {
      char = "󰍛";
      hexCode = "nf-md-F037B";
    }; # nf-md-chip (used for VHDL/Verilog/SystemVerilog)
    clojure = {
      char = "";
      hexCode = "nf-dev-E768";
    }; # nf-dev-clojure
    clojureAlt = {
      char = "";
      hexCode = "nf-dev-E76A";
    }; # nf-dev-clojure_alt (for cljs/cljd/edn)
    fennel = {
      char = "";
      hexCode = "nf-seti-E6AF";
    }; # nf-seti-fennel
    schemeLisp = {
      char = "󰘧";
      hexCode = "nf-md-F0627";
    }; # nf-md-lisp (used for Scheme/Lisp)
    customSchemeLisp = {
      char = "";
      hexCode = "e6b1";
    }; # nf-md-lisp (used for Scheme/Lisp)
    hurl = {
      char = "";
      hexCode = "nf-fa-F00EC";
    }; # nf-fa-download (reused icon for Hurl language)
    azureBicep = {
      char = "";
      hexCode = "nf-dev-E63B";
    }; # nf-dev-azure
    ...
    drlRules = {
      char = "";
      hexCode = "nf-fae-E88C";
    }; # nf-fae-cogs_drifting (for DRL rules files)
    cuda = {
      char = "";
      hexCode = "nf-seti-E64B";
    }; # nf-seti-cuda
    prisma = {
      char = "";
      hexCode = "nf-seti-E684";
    }; # nf-seti-prisma
    powershell = {
      char = "󰨊";
      hexCode = "nf-md-F0A0A";
    ...
    shader = {
      char = "";
      hexCode = "nf-seti-E6AC";
    }; # nf-seti-shaderlab
    prettier = {
      char = "";
      hexCode = "nf-seti-E6B2";
    }; # nf-seti-prettier
    eslint = {
      char = "";
      hexCode = "nf-seti-E655";
    }; # nf-seti-eslint
    commitlint = {
      char = "󰜘";
      hexCode = "nf-md-F0718";
    ...
    testFile = {
      char = "";
      hexCode = "nf-md-F0499";
    }; # nf-md-flask (generic for test files like .spec.js)
    nodejs = {
      char = "";
      hexCode = "nf-dev-E718";
    }; # nf-dev-nodejs
  ...
  files = {
    ...
    json = {
      char = "";
      hexCode = "nf-dev-E60B";
    }; # nf-dev-json (also for json5, jsonc, webmanifest)
    genericConfig = {
      char = "";
      hexCode = "nf-dev-E615";
    }; # nf-dev-terminal (used for many config files: ini, yaml, .bashrc etc.)
    editorConfig = {
      char = "";
      hexCode = "nf-seti-E652";
    }; # nf-seti-editorconfig
    lockFile = {
      char = "";
      hexCode = "nf-seti-E672";
    }; # nf-seti-lock
    binary = {
      char = "";
      hexCode = "nf-cod-EB68";
    }; # nf-cod-file_binary (for bin, elf, exe, dll, lib, so)
    backup = {
      char = "󰁯";
      hexCode = "nf-md-F006F";
    }; # nf-md-backup_restore (for .bak)
    database = {
      char = "";
      hexCode = "nf-dev-E706";
    }; # nf-dev-database (for sql, sqlite, db, dump)
    hexFile = {
      char = "";
      hexCode = "nf-seti-E667";
    }; # nf-seti-hex
    archive = {
      char = "";
      hexCode = "nf-md-F0450";
    }; # nf-md-file_zip_outline (for zip, tar, gz, bz2, xz, rar, 7z, zst)
    diskImage = {
      char = "";
      hexCode = "nf-fa-E87A";
    }; # nf-fa-hdd_o (for iso, img)
    rpmPackage = {
      char = "󰣇";
      hexCode = "nf-md-F08C7";
    ...
    package = {
      char = "";
      hexCode = "nf-md-F0487";
    }; # nf-md-package (for godot .pck)
    diff = {
      char = "";
      hexCode = "nf-dev-E728";
    }; # nf-dev-git_compare (for diff, patch)
    fontFile = {
      char = "";
      hexCode = "nf-fa-F019C";
    }; # nf-fa-font (for ttf, otf, woff, woff2, flf, flc, lff)
    xml = {
      char = "󰗀";
      hexCode = "nf-md-F05C0";
    }; # nf-md-xml
  ...
  osAndEnvironments = {
    ...
    linuxConfig = {
      char = "";
      hexCode = "nf-linux-F0369";
    }; # nf-linux-linux (general linux config, xinitrc, xsession, Xresources, Xauthority)
    archLinux = {
      char = "";
      hexCode = "nf-linux-F0303";
    }; # nf-linux-archlinux (for PKGBUILD)
    tmux = {
      char = "";
      hexCode = "nf-custom-EFD8";
    }; # nf-custom-tmux
    shell = {
      char = "";
      hexCode = "nf-dev-E7A5";
    }; # nf-dev-terminal (for sh, bash, zsh, csh, ksh, fish)
    desktop = {
      char = "";
      hexCode = "nf-fa-F0108";
    }; # nf-fa-desktop (for .desktop files)
    kdeConfig = {
      char = "";
      hexCode = "nf-linux-F0373";
    }; # nf-linux-kde (for kdeglobals, kalgebrarc, cantorrc)
    lxdeConfig = {
      char = "";
      hexCode = "nf-linux-F0363";
    }; # nf-linux-lxde (for lxde-rc.xml)
    lxqtConfig = {
      char = "";
      hexCode = "nf-linux-F0364";
    }; # nf-linux-lxqt (for lxqt.conf)
    jwmConfig = {
      char = "";
      hexCode = "nf-fa-F035B";
    }; # nf-fa-terminal (for jwmrc)
    dconfConfig = {
      char = "";
      hexCode = "nf-fa-F0361";
    }; # nf-fa-cubes (for dconf)
    gtkConfig = {
      char = "";
      hexCode = "nf-linux-F0362";
    }; # nf-linux-gtk (for gtkrc, .gtkrc-2.0, gresource)
    nixos = {
      char = "";
      hexCode = "nf-linux-F0313";
    }; # nf-linux-nixos
    xmonadConfig = {
      char = "";
      hexCode = "nf-fa-F035E";
    }; # nf-fa-square_o (for xmonad.hs, xmobarrc)
    hyprlandConfig = {
      char = "";
      hexCode = "nf-fa-F0359";
    }; # nf-fa-square (for hyprland.conf, hypridle.conf, hyprlock.conf)
    i3Config = {
      char = "";
      hexCode = "nf-fa-F035A";
    }; # nf-fa-sliders (for i3status.conf, i3blocks.conf)
    bspwmSxhkd = {
      char = "";
      hexCode = "nf-fa-F0355";
    }; # nf-fa-dot_circle_o (for bspwmrc, sxhkdrc)
    westonConfig = {
      char = "";
      hexCode = "nf-fa-F0367";
    }; # nf-fa-lemon_o (for weston.ini)
    linuxKernel = {
      char = "";
      hexCode = "nf-fa-F029C";
    }; # nf-fa-linux (for ko files, linux kernel modules)
  };
  ...
  buildTools = {
    buildGeneric = {
      char = "";
      hexCode = "nf-dev-E63A";
    }; # nf-dev-build (used for build, workspace, bazel)
    gradle = {
      char = "";
      hexCode = "nf-seti-E660";
    }; # nf-seti-gradle
    grunt = {
      char = "";
      hexCode = "nf-dev-E611";
    ...
    makefile = {
      char = "";
      hexCode = "nf-dev-E779";
    }; # nf-dev-go (used for GNUmakefile and makefile)
    cmake = {
      char = "";
      hexCode = "nf-dev-E615";
    }; # nf-dev-terminal (reused from genericConfig)
    justfile = {
      char = "";
      hexCode = "nf-fa-F021D";
    }; # nf-fa-upload
  ...
  cadAnd3d = {
    ...
    cadGeneric = {
      char = "󰻫";
      hexCode = "nf-md-F0F6B";
    }; # nf-md-cube_scan (generic CAD, for skp, brep, dxf, iges, ifc, sldprt, sldasm, step, stp, ste)
    openSCAD = {
      char = "";
      hexCode = "nf-fa-F034E";
    }; # nf-fa-cube
    ...
    _3dModelGeneric = {
      char = "󰆧";
      hexCode = "nf-md-F01A1";
    }; # nf-md-cube_outline (generic 3D model, for obj, wrz, wrl, ply, 3mf, stl, fbx)
    prusaslicer = {
      char = "";
      hexCode = "nf-fa-F0351";
    }; # nf-fa-tree
  ...
  designAndMedia = {
    ...
    image = {
      char = "";
      hexCode = "nf-dev-E60D";
    }; # nf-dev-image (for png, jpg, jpeg, webp, avif, jxl, bmp, ico)
    audio = {
      char = "";
      hexCode = "nf-fa-F0013";
    }; # nf-fa-music (for aif, aiff, aac, ape, flac, wvc, pcm, wma, mp3, ogg, opus, wav, wv)
    video = {
      char = "";
      hexCode = "nf-seti-E69F";
    }; # nf-seti-video (for mp4, mov, mkv, 3gp, webm, cast, m4v)
    playlist = {
      char = "󰲹";
      hexCode = "nf-md-F0CA5";
    }; # nf-md-playlist_music_outline (for m3u, m3u8, pls, cue)
    subtitle = {
      char = "󰨖";
      hexCode = "nf-md-F0A16";
    }; # nf-md-subtitles_outline (for lrc, ass, sub, srt, ssa)
    kdenlive = {
      char = "";
      hexCode = "nf-linux-F033C";
    }; # nf-linux-kdenlive
    vlc = {
      char = "󰕼";
      hexCode = "nf-md-F057C";
  ...
  documents = {
    markdown = {
      char = "";
      hexCode = "nf-md-F048A";
    }; # nf-md-language_markdown (for md, mdx, rmd)
    pdf = {
      char = "";
      hexCode = "nf-cod-EB6B";
    }; # nf-cod-file_pdf
    word = {
      char = "󰈬";
      hexCode = "nf-md-F020B";
    }; # nf-md-microsoft_word (for doc, docx)
    excel = {
      char = "󰈛";
      hexCode = "nf-md-F021F";
    }; # nf-md-microsoft_excel (for xls, xlsx)
    powerpoint = {
      char = "󰈧";
      hexCode = "nf-md-F021A";
    }; # nf-md-microsoft_powerpoint (for ppt)
    ebook = {
      char = "";
      hexCode = "nf-fae-E88B";
    }; # nf-fae-book_open (for epub, mobi)
    latex = {
      char = "";
      hexCode = "nf-seti-E69B";
    }; # nf-seti-tex (for tex, bib)
    bibtex = {
      char = "󱉟";
      hexCode = "nf-md-F125F";
    }; # nf-md-text_box
  ...
  web = {
    ...
    htmlTemplate = {
      char = "";
      hexCode = "nf-dev-E60E";
    }; # nf-dev-html5 (for erb, haml, slim, ejs, pug)
    favicon = {
      char = "";
      hexCode = "nf-dev-E613";
    }; # nf-dev-favicon
    ...
    svelte = {
      char = "";
      hexCode = "nf-seti-E697";
    }; # nf-seti-svelte
    astro = {
      char = "";
      hexCode = "nf-seti-E6B3";
    }; # nf-seti-astro
    twig = {
      char = "";
      hexCode = "nf-dev-E61C";
  ...
  security = {
    ...
    publicKey = {
      char = "󰷖";
      hexCode = "nf-md-F0DE6";
    }; # nf-md-lock_open_variant_outline (for .pub files)
    metasploit = {
      char = "";
      hexCode = "nf-fa-F0370";
    }; # nf-fa-metasploit (for msf)
    ascKey = {
      char = "󰦝";
      hexCode = "nf-md-F099D";
    }; # nf-md-key (for .asc files)
  };
  ...
  misc = {
    fire = {
      char = "";
      hexCode = "nf-md-F040C";
    }; # nf-md-fire (also used for Mojo language)
    xm = {
      char = "";
      hexCode = "nf-seti-E691";
    }; # nf-seti-xm (general X and XML related files)
    query = {
      char = "";
      hexCode = "nf-oct-E81C";
    }; # nf-oct-search (for general query files)
  };
}
