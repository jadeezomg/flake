...
function M.setup(config, platform)
	-- Keep default keybindings enabled
	-- To customize keybindings, uncomment and modify the config.keys table below
	-- config.disable_default_key_bindings = true
	
	-- Platform-specific modifier key handling
	-- SUPER = CMD on macOS, Windows key on Windows/Linux
	-- On macOS, many standard shortcuts use CMD (SUPER) instead of CTRL
	local super_mod = "SUPER"
	local ctrl_mod = "CTRL"
	
	-- Custom keybindings (currently commented out - using defaults)
	-- Uncomment and modify as needed to override default keybindings
	-- Example keybindings are preserved below for reference
	--[[
	config.keys = {
		...
		-- macOS uses CMD+C/V, Windows/Linux use CTRL+C/V
		-- These are already covered above, but ensure compatibility
		{
			key = "O",
			mods = "CTRL|ALT",
			-- toggling opacity
	...
	-- Mousing bindings (active - these override defaults)
